...
def cross_validation2(data, file_path):
    ...
    while i <= 1:
        ...
        training_set = fold1 + fold2 + fold3 + fold4
        validation_set = fold5
        can_be_prune1, t6 = prune_min_info_gain(t1, can_be_prune1, i)
        accuracy_validation += get_prediction_accuracy(t6, validation_set, 100)
        accuracy_training += get_prediction_accuracy(t6, training_set, 100)

        training_set = fold1 + fold2 + fold3 + fold5
        validation_set = fold4
        can_be_prune2, t7 = prune_min_info_gain(t2, can_be_prune2, i)
        accuracy_validation += get_prediction_accuracy(t7, validation_set, 100)
        accuracy_training += get_prediction_accuracy(t7, training_set, 100)

        training_set = fold1 + fold2 + fold4 + fold5
        validation_set = fold3
        can_be_prune3, t8 = prune_min_info_gain(t3, can_be_prune3, i)
        accuracy_validation += get_prediction_accuracy(t8, validation_set, 100)
        accuracy_training += get_prediction_accuracy(t8, training_set, 100)

        training_set = fold1 + fold3 + fold4 + fold5
        validation_set = fold2
        can_be_prune4, t9 = prune_min_info_gain(t4, can_be_prune4, i)
        accuracy_validation += get_prediction_accuracy(t9, validation_set, 100)
        accuracy_training += get_prediction_accuracy(t9, training_set, 100)

        training_set = fold2 + fold3 + fold4 + fold5
        validation_set = fold1
        can_be_prune5, t10 = prune_min_info_gain(t5, can_be_prune5, i)
        accuracy_validation += get_prediction_accuracy(t10, validation_set, 100)
        accuracy_training += get_prediction_accuracy(t10, training_set, 100)
